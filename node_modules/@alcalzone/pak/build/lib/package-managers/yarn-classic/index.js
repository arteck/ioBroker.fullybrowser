...
exports.YarnClassic = void 0;
const execa_1 = __importDefault(require("execa"));
const fs = __importStar(require("fs-extra"));
const path = __importStar(require("path"));
const package_manager_1 = require("../package-manager");
function setLoglevel(args, loglevel) {
    if (loglevel === "silent" || loglevel === "verbose") {
        args.push(`--${loglevel}`);
    }
}
class YarnClassic extends package_manager_1.PackageManager {
    /** Executes a "raw" yarn command */
    async command(args, options = {}) {
        var _a, _b, _c, _d, _e, _f;
        const promise = execa_1.default("yarn", args, Object.assign(Object.assign({}, options), { cwd: this.cwd, reject: false, all: true }));
        ...
        return package_manager_1.execaReturnValueToCommandResult(result);
    }
    /**
    ...
    async detect(requireLockfile = true, setCwdToPackageRoot = false) {
        try {
            ...
            if (!(await this.version()).startsWith("1."))
                return false;
